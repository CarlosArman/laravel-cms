<div class="p-6">
                ...
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            @else
                                <tr>
                                    <td class="px-6 py-4 text-sm whitespace-nowrap" colspan="4">No Reults Found.</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
    ...
    <x-jet-dialog-modal wire:model="modalFormVisible">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
             <label for="">
                 <input class="form-checkbox" type="checkbox" name="" id="" value="{{$isSetToDefaultHomePage}}" wire:model="isSetToDefaultHomePage">
                <span class="ml-2 text-sm text-gray-600"> {{ __('Set as the default home page') }}</span>
            </label>
            </div>
            <div class="mt-4">
                <label for="">
                    <input class="form-checkbox" type="checkbox" name="" id="" value="{{$isSetToDefaultNotFoundPage}}" wire:model="isSetToDefaultNotFoundPage">
                   <span class="ml-2 text-sm text-red-600"> {{ __('Set as the default 404 error page') }}</span>
               </label>
               </div>
            <div class="mt-4">
